...
public class OrdersDao extends BaseDao {
    ...
    // cập nhật trạng thái của order thành CANCEL, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order của 1 userID trong ngày hôm nay, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order của 1 userID trong tuần này, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order của 1 userID trong tháng này, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order của 1 userID đã được giao hàng, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order của 1 userID đã được giao hàng trong ngày hôm nay, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order của 1 userID đã được giao hàng trong tuần này, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order của 1 userID đã được giao hàng trong tháng này, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order của 1 userID đang được giao hàng, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order của 1 userID đang được giao hàng trong ngày hôm nay, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order của 1 userID đang được giao hàng trong tuần này, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order của 1 userID đang được giao hàng trong tháng này, nếu thất bại sẽ ném RuntimeException
    ...
    // trả về list order details của 1 userID đã được giao hàng, nếu thất bại sẽ ném RuntimeException
